...
export default function NotFound() {
    return (<div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="max-w-2xl text-center">
        <img src="/images/404.svg" alt="Page not found" width={300} height={300} className="mx-auto mb-6"/>
        ...
        <Link to="/" className="inline-block px-6 py-3 bg-black text-white text-lg rounded-xl hover:bg-gray-800 transition">
          Go Back Home
        </Link>
      </div>
    </div>);
